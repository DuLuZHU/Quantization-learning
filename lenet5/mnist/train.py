...
print(model)
# torch.save(model.state_dict(), './model/model-mnist.pth')   #仅保存学习到的参数
torch.save(model, './model/model-mnist.pth')    #保存整个model的状态
...
def Convert_ONNX():
    ...
    torch.onnx.export(model, dummy_input, "lenet5-mnist.onnx")
...
if __name__ == "__main__": 
    ...
    torch.load("./model/model-mnist.pth")
